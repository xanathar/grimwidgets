...
\
")
spawn("script_entity", 29,31,2, "spell_book_gui")
...
\9\9\
\9\9local runeImg = runes:addChild('image','rune_'..runeChar,0,0,100,100,spell_book_gui.getRuneImage(runeChar))\
\9\9local pos = spell_book_gui.getRunePosition(runeChar)\
...
\9\
\9\9\
\9local book = spell_book_gui.createSpellBook()\
